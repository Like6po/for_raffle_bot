...
def create_channel_router(session_pool, bot_pickle, scheduler: AsyncIOScheduler) -> Router:
    ...
    r.my_chat_member.middleware(InitMiddleware(session_pool, bot_pickle, scheduler))
    r.callback_query.middleware(InitMiddleware(session_pool, bot_pickle, scheduler))
